...
double dT_PD      	= 0.001;        // sampling time for PD loop in seconds
double dT_XD    	  = 0.1;         // sampling time for xd loop in seconds
double dT_PO      	= 0.01;          // sampling time for power sampling loop in seconds   
...
float xd           	= 300.0;		  // desired value of position  in no. of rotations
...
float I_range     	= 2.0;		  // for range -x to +x put I_range = x // for calculating PWM value
